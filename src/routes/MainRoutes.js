...
//product - tabs
const Health = Loadable(lazy(() => import('pages/health/health')));
const HealthDetails = Loadable(lazy(() => import('pages/health/healthDetails')));
const Mall = Loadable(lazy(() => import('pages/mall/mall')));
const MallDetails = Loadable(lazy(() => import('pages/mall/mallDetails')));
const Education = Loadable(lazy(() => import('pages/education/education')));
const EducationDetails = Loadable(lazy(() => import('pages/education/educationDetails')));
