              ...
              <Grid container spacing={{ xs: 5, md: 2 }}>
                ...
                <Grid item xs={6} sm={4}>
                  <Stack spacing={3}>
                    ...
                    <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                      <FooterLink href="https://codedthemes.gitbook.io/able-pro-bootstrap/" target="_blank" underline="none">
                        Documentation
                      </FooterLink>
                      <FooterLink href="https://codedthemes.gitbook.io/able-pro-bootstrap/roadmap/" target="_blank" underline="none">
                        Feature Request
                      </FooterLink>
                      <FooterLink href="https://codedthemes.gitbook.io/able-pro-bootstrap/roadmap/" target="_blank" underline="none">
                        RoadMap
